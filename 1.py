...
# 	b) Print the sum of d plus your double variable to a scale
# 	   of one decimal place on a new line.
# 	c) Concatenate s with the string you read as input and print
# 	   the result on a new line.

# Note: If you are using a language that doesn't support using
# for string concatenation(e.g.: C), you can just print one
